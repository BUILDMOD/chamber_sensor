...
<main class="main">
  <header class="topbar">
    ...
    <div style="display:flex;align-items:center;gap:12px;">
      <?php if($isOwner): ?>
      <button class="btn btn-primary" id="openAddRule"><i class="fas fa-plus"></i> Add Rule</button>
      <button class="btn btn-ghost" id="openAddSchedule"><i class="fas fa-clock"></i> Add Schedule</button>
      <?php endif; ?>
